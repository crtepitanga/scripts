...
13DXS00000)
 PREFIXO='e'
    echo -e "\e[46m Lenovo 13DXS00000 \e[0m "
    echo "encontrado Lenovo 13DXS00000 aqui"
    	echo -e "\e[46m ***************************************************************************** \e[0m "
            ...
            echo "PING OK e tem SSH"
            {
               ...
               for USUARIO in "${USUARIOS[@]}" ; do
                   ...
                   if [ "$(grep "DELLLL aquii" "/tmp/.resultado.txt.$$" | wc -l)" -gt 0 ]; then
                      ...
                      elif [ "$(grep "encontrado Lenovo 13DXS00000 aqui" "/tmp/.resultado.txt.$$" | wc -l)" -gt 0 ]; then
                      export qtLenovo=$((qtLenovo+1))
...
echo "Acessados $qtLenovo ips de Lenovo 13DXS00000"
