...
APLICATIVOS=( "/usr/bin/xdg-desktop-icon" "/usr/bin/xfdesktop-settings" "/usr/bin/xfdesktop" "/usr/bin/nm-applet" "/usr/bin/xfce4-appearance-settings" "/usr/bin/users-admin" "/usr/bin/mugshot" "/usr/bin/mate-about-me" "/usr/bin/mintupdate" "/usr/bin/mintinstall" "/usr/bin/nm-connection-editor" )
